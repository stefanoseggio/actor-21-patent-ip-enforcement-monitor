...
export function mapRecordToGraph(record: UnifiedRecord): GraphMappingResult {
    const jurisdictionCode = record.jurisdiction;
    const jurisdiction: JurisdictionNode = { label: 'Jurisdiction', code: jurisdictionCode };

    const publicBody: PublicBodyNode = {
        label: 'PublicBody',
        name: record.awarding_or_regulating_agency ?? 'Unknown regulator',
        jurisdiction: jurisdictionCode,
    };

    const sanction: SanctionNode = {
        label: 'Sanction',
