...
export declare function fetchJsonWithRetry<T>(url: string, init: RequestInit, options?: RetryOptions): Promise<T>;
...
export declare function fetchTextWithRetry(url: string, init: RequestInit, options?: RetryOptions): Promise<string>;
